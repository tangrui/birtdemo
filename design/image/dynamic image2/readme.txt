...
Example report designs that dyamically changes the image.Two different approaches for getting dynamic images into a BIRT report design.  One approach use a script on the image onRender event to change the name of the image at runtime:
